...
public class LibraryCatalog  {
    ...
    // Method that breaks encapsulation: bad practice!
    ...
    public List<Book> getBooks2() {
        ...
        // TODO: Modify this method to return a "deep" copy (consider using stream() and map() and toList() methods - see documentation)
